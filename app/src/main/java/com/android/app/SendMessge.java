...
public class SendMessge {
    ...
    public static String myEmailAccount = "zhaoligang@breakpoint";

    public static String myEmailPassword = "zTC2f6KX852s8tUo";
    // 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com

    // 网易163邮箱的 SMTP 服务器地址为: smtp.163.com    腾讯: smtp.qq.com
    public static String myEmailSMTPHost = "smtp.exmail.qq.com";
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "1747896448@qq.com";
